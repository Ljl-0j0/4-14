 ...
 * @Description: 
 * @Author: ljl
 * @Date: 2025-04-23 20:17:06
 * @LastEditors: rendc
 * @LastEditTime: 2025-04-26 11:10:20
-->
# 【布局技巧：margin负值、文字围绕浮动、行内快、CSS三角、CSS初始化】
- [【布局技巧：margin负值、文字围绕浮动、行内快、CSS三角、CSS初始化】](#布局技巧margin负值文字围绕浮动行内快css三角css初始化)
- [一、margin负值的运用](#一margin负值的运用)
- [二、文字围绕浮动元素](#二文字围绕浮动元素)
- [三、行内块的巧妙运用](#三行内块的巧妙运用)
- [四、CSS三角强化](#四css三角强化)
- [五、CSS初始化](#五css初始化)
...
![](img/20210422131248993.gif)

# 二、文字围绕浮动元素

![](img/20210422131515568.png)
...
![](img/20210422132128826.png)

# 三、行内块的巧妙运用

![](img/20210422132128827.png)
...
![](img/20210422132739686.png)

# 四、CSS三角强化

![](img/20210422132739687.png)
