 ...
 * @Description: 
 * @Author: ljl
 * @Date: 2025-04-26 11:14:17
 * @LastEditors: rendc
 * @LastEditTime: 2025-05-14 19:06:52
-->
# 【PC端品优购项目】

## 电商—主页

![](mark-img/20210423230039123.jpg)

## 电商—分类列表页

![](mark-img/20210423230312162.jpg)

## 电商—注册页

![](mark-img/20210423230344469.jpg)
...
@font-face {
    font-family: 'icomoon';
    src:  url('../fonts/icomoon.eot?27fiuh');
    src:  url('../fonts/icomoon.eot?27fiuh#iefix') format('embedded-opentype'),
      url('../fonts/icomoon.ttf?27fiuh') format('truetype'),
      url('../fonts/icomoon.woff?27fiuh') format('woff'),
      url('../fonts/icomoon.svg?27fiuh#icomoon') format('svg');
    font-weight: normal;
    font-style: normal;
    font-display: block;
}
...
<head>
    ...
    <!-- 网站说明 -->
    <meta name="description" content="品优购商城（PIN）是一个专业为消费者提供购物的购物商城。品优购商城（PIN）致力于成为中国消费者最值得信赖的购物商城，为消费者提供便捷的购物体验。">
    <!-- 网站关键字 -->
    <meta name="keywords" content="网上购物,网上商城,手机,耳机,充电器,CD,MP3,MP4,相机,数码,办公用品">
    
    <!-- 图标 -->
    <link rel="shortcut icon" href="pin.ico" type="image/x-icon">
...
<body>
    ...
    <header class="header w">
        ...
        <!-- hotwords模块 -->
         <div class="hotwords">
            <a href="#" class="style_red">优惠购首页</a>
            <a href="#">亿元优惠</a>
            <a href="#">9.9元团购</a>
            <a href="#">美满99减30</a>
            <a href="#">办公用品</a>
            ...
            <div class="dropdown">
                ...
                <div class="dd">
                    <ul>
                        ...
                        <li><a href="#">家具、</a><a href="#">厨具、</a><a href="#">家居</a></li>
        ...
        <main class="main">
            ...
            <div class="newsflash">
                <div class="news">
                    ...
                    <div class="news_bd">
                        <ul>
                            <li><a href="#"><strong>[特惠]</strong> 备战开学季 全民半价购数码 别急别急</a></li>
                            ...
                            <li><a href="#"><strong>[特惠]</strong> 每日享折扣品优品质量</a></li>
                        </ul>
                    </div>
                </div>
                <div class="lifeservice">
        ...
        <div class="likes_bd">
            <ul>
                <li>
                    ...
                    <p class="product-price">116.00</p>
                </li>
                <li>
    ...
    <div class="w">
        ...
        <div class="mod_help">
            ...
            <dl>
                <dt>帮助中心</dt>
                <dd><img src="images/erweima.png" alt="">
                品优购客户端
                </dd>
            </dl>
        </div>
...
.discount-tag{
    ...
    border-top: 15px solid #579e5c;
    border-left: 7px solid #579e5c;    /* 左侧边框宽度 */
    border-right: 7px solid #579e5c; 
