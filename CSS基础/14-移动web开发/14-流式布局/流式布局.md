 ...
 * @Description: 
 * @Author: ljl
 * @Date: 2025-05-12 19:52:43
 * @LastEditors: rendc
 * @LastEditTime: 2025-05-12 19:52:48
-->
# 【移动Web开发之流式布局】
- [【移动Web开发之流式布局】](#移动web开发之流式布局)
- [一、移动端基础](#一移动端基础)
  - [1.1 浏览器现状](#11-浏览器现状)
  - [1.2 手机屏幕现状](#12-手机屏幕现状)
  - [1.3 常见移动端屏幕尺寸](#13-常见移动端屏幕尺寸)
  - [1.4 移动端调试方法](#14-移动端调试方法)
  - [1.5 总结](#15-总结)
- [二、视口](#二视口)
  - [2.1 布局视口（layout viewport）](#21-布局视口layout-viewport)
  - [2.2 视觉视口（value viewport）](#22-视觉视口value-viewport)
  - [2.3 理想视口（ideal viewport）](#23-理想视口ideal-viewport)
  - [2.4 总结](#24-总结)
  - [2.5 meta视口标签](#25-meta视口标签)
  - [2.6 标准的viewport设置](#26-标准的viewport设置)
- [三、二倍图](#三二倍图)
  - [3.1 物理像素\&物理像素比](#31-物理像素物理像素比)
  - [3.2 多倍图](#32-多倍图)
  - [3.3 背景缩放](#33-背景缩放)
  - [3.4 多倍图切工具 cutterman](#34-多倍图切工具-cutterman)
- [四、移动端开发选择](#四移动端开发选择)
  - [4.1 移动端主流方案](#41-移动端主流方案)
  - [4.2 单独移动端页面（主流）](#42-单独移动端页面主流)
  - [4.3 响应式兼容移动端（其次）](#43-响应式兼容移动端其次)
  - [4.4 总结](#44-总结)
- [五、移动端技术解决方案](#五移动端技术解决方案)
  - [5.1 移动端浏览器](#51-移动端浏览器)
  - [5.2 CSS初始化 normalize.css](#52-css初始化-normalizecss)
  - [5.3 CSS3盒子模型 box-sizing](#53-css3盒子模型-box-sizing)
  - [5.4 移动端特殊样式](#54-移动端特殊样式)
- [六、移动端常见布局](#六移动端常见布局)
  - [6.1 流式布局（百分比布局）](#61-流式布局百分比布局)
  - [6.2 案例：京东移动端首页](#62-案例京东移动端首页)
  - [6.3 京东移动端案例重点强调](#63-京东移动端案例重点强调)
    - [6.3.1 搜索框](#631-搜索框)
    - [6.3.2 图片底部空白](#632-图片底部空白)
    - [6.3.3 二倍精灵图做法](#633-二倍精灵图做法)
    - [6.3.4 竖线的选型](#634-竖线的选型)
