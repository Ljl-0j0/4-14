...
- [【移动Web开发之flex布局】](#移动web开发之flex布局)
- [一、flex布局体验](#一flex布局体验)
    - [1.1 传统布局与flex布局](#11-传统布局与flex布局)
    - [1.2 初体验](#12-初体验)
- [二、flex布局原理](#二flex布局原理)
    - [2.1 布局原理](#21-布局原理)
- [三、flex布局父项常见属性](#三flex布局父项常见属性)
    - [3.1 常见父项属性](#31-常见父项属性)
    - [3.2 flex-direction设置主轴的方向](#32-flex-direction设置主轴的方向)
    - [3.3 justify-content设置主轴上的子元素排列方式](#33-justify-content设置主轴上的子元素排列方式)
    - [3.4 flex-wrap设置子元素是否换行](#34-flex-wrap设置子元素是否换行)
    - [3.5 align-items设置侧轴上的子元素排列方式（单行）](#35-align-items设置侧轴上的子元素排列方式单行)
    - [3.6 align-content 设置侧轴上的子元素的排列方式（多行）](#36-align-content-设置侧轴上的子元素的排列方式多行)
    - [3.7 align-content和align-items区别](#37-align-content和align-items区别)
    - [3.8 flex-flow](#38-flex-flow)
- [四、flex布局子项常见属性](#四flex布局子项常见属性)
    - [4.1 flex属性](#41-flex属性)
    - [4.2 align-self控制子项自己在侧轴上的排列方式](#42-align-self控制子项自己在侧轴上的排列方式)
    - [4.3 order属性定义项目的排列顺序](#43-order属性定义项目的排列顺序)
- [五、携程网首页案例制作](#五携程网首页案例制作)
- [六、携程网首页案例重点强调](#六携程网首页案例重点强调)
    - [6.1 搜索模块](#61-搜索模块)
    - [6.2 渐变](#62-渐变)
        - [6.2.1 背景渐变](#621-背景渐变)
        - [6.2.2 文字渐变](#622-文字渐变)
