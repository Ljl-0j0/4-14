...
- [【移动Web开发之rem适配布局】](#移动web开发之rem适配布局)
- [一、rem单位](#一rem单位)
    - [1.1 rem 单位](#11-rem-单位)
- [二、媒体查询](#二媒体查询)
    - [2.1 什么是媒体查询](#21-什么是媒体查询)
    - [2.2 语法规范](#22-语法规范)
        - [2.2.1 mediatype 查询类型](#221-mediatype-查询类型)
        - [2.2.2 关键字](#222-关键字)
        - [2.2.3 媒体特性](#223-媒体特性)
    - [2.3 媒体查询+rem实现元素动态大小变化](#23-媒体查询rem实现元素动态大小变化)
    - [2.4 引入资源（理解）](#24-引入资源理解)
- [三、Less基础](#三less基础)
    - [3.1 维护CSS的弊端](#31-维护css的弊端)
    - [3.2 Less介绍](#32-less介绍)
    - [3.3 Less安装（注意如果使用VSCode无需安装Less）](#33-less安装注意如果使用vscode无需安装less)
    - [3.4 Less变量](#34-less变量)
        - [3.4.1 变量命名规范](#341-变量命名规范)
        - [3.4.2 变量使用规范](#342-变量使用规范)
    - [3.5 Less编译](#35-less编译)
    - [3.6 Less嵌套](#36-less嵌套)
    - [3.7 Less运算](#37-less运算)
- [四、rem适配方案](#四rem适配方案)
    - [4.1 rem实际开发适配方案](#41-rem实际开发适配方案)
    - [4.2 rem适配方案技术使用（市场主流）](#42-rem适配方案技术使用市场主流)
    - [4.3 rem实际开发适配方案1](#43-rem实际开发适配方案1)
- [五、苏宁网首页案例制作](#五苏宁网首页案例制作)
- [六、rem适配方案2](#六rem适配方案2)
    - [6.1 简洁高效的rem适配方案flexible.js](#61-简洁高效的rem适配方案flexiblejs)
    - [6.2 使用适配方案2制作苏宁移动端首页](#62-使用适配方案2制作苏宁移动端首页)
