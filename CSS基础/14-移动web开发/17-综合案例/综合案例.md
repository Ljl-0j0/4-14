 ...
 * @LastEditors: rendc
 * @LastEditTime: 2025-05-14 15:21:52
-->
# 【移动Web开发之综合案例】

- [【移动Web开发之综合案例】](#移动web开发之综合案例)
  - [黑马面面布局开发](#黑马面面布局开发)
    - [一、目的](#一目的)
      - [1.1  技术方案](#11--技术方案)
      - [1.2 代码规范](#12-代码规范)
      - [1.2 目录规范](#12-目录规范)
    - [二、流程开发](#二流程开发)
      - [2.1 蓝湖/摹客协作平台](#21-蓝湖摹客协作平台)
      - [2.2 适配方案](#22-适配方案)
      - [2.3  初始化文件](#23--初始化文件)
      - [2.4 布局模块](#24-布局模块)
      - [2.5 swiper 插件使用](#25-swiper-插件使用)
      - [2.6 图标字体上传下载](#26-图标字体上传下载)
      - [2.7  上传码云并发布部署静态网站](#27--上传码云并发布部署静态网站)
