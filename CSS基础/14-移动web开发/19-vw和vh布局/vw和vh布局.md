 ...
 * @Description: 
 * @Author: ljl
 * @Date: 2025-05-14 15:10:34
 * @LastEditors: rendc
 * @LastEditTime: 2025-05-14 15:21:16
-->
# 【移动端Web开发之vw和vh布局】

- [【移动端Web开发之vw和vh布局】](#移动端web开发之vw和vh布局)
- [一、vw和vh](#一vw和vh)
    - [1.1 移动端布局](#11-移动端布局)
    - [1.2 vw/vh是什么？](#12-vwvh是什么)
    - [1.3 vw/vh怎么用？](#13-vwvh怎么用)
    - [1.4 vw注意事项](#14-vw注意事项)
    - [1.5 VSCode px-\>vw 插件](#15-vscode-px-vw-插件)
- [二、移动端布局推荐](#二移动端布局推荐)
