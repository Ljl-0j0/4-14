# 【CSS复合选择器、元素显示模式、背景】
- [【CSS复合选择器、元素显示模式、背景】](#css复合选择器元素显示模式背景)
- [一、CSS 的复合选择器](#一css-的复合选择器)
    - [1.1 什么是复合选择器](#11-什么是复合选择器)
    - [1.2 后代选择器](#12-后代选择器)
    - [1.3 子选择器](#13-子选择器)
    - [1.4 并集选择器](#14-并集选择器)
    - [1.5 伪类选择器](#15-伪类选择器)
    - [1.6 链接伪类选择器](#16-链接伪类选择器)
    - [1.7 :focus伪类选择器](#17-focus伪类选择器)
    - [1.8 复合选择器总结](#18-复合选择器总结)
- [二、CSS 的元素显示模式](#二css-的元素显示模式)
    - [2.1 什么是元素显示模式](#21-什么是元素显示模式)
    - [2.2 块元素](#22-块元素)
    - [2.3 行内元素](#23-行内元素)
    - [2.4 行内块元素](#24-行内块元素)
    - [2.5 元素显示模式总结](#25-元素显示模式总结)
    - [2.6 元素显示模式转换](#26-元素显示模式转换)
    - [2.7 简洁版小米侧边栏案例](#27-简洁版小米侧边栏案例)
    - [2.8 小技巧：单行文字垂直居中](#28-小技巧单行文字垂直居中)
    - [2.9 一个注意点：块级元素不会自动换行](#29-一个注意点块级元素不会自动换行)
- [三、CSS 的背景](#三css-的背景)
    - [3.1 背景颜色](#31-背景颜色)
    - [3.2 背景图片](#32-背景图片)
    - [3.3 背景平铺](#33-背景平铺)
    - [3.4 背景图片位置](#34-背景图片位置)
    - [3.5 背景图像固定（背景附着）](#35-背景图像固定背景附着)
    - [3.6 背景复合写法](#36-背景复合写法)
    - [3.7 背景色半透明](#37-背景色半透明)
    - [3.8 背景总结](#38-背景总结)
    - [3.9 王者荣耀案例](#39-王者荣耀案例)
...
<img src="img/20210405203010954.gif" style="width:50%;" />
...
<img src="img/image.png" style="width:90%;" />
...
<img src="img/20210405205628339.gif" style="width:50%;" />
...
<img src="img/image1.png" style="width:70%;" />
...
<img src="img/20210405213212859.jpg" style="zoom:80%;" />
