 ...
 * @LastEditors: rendc
 * @LastEditTime: 2025-04-22 10:02:50
-->
# 【CSS浮动】
- [【CSS浮动】](#css浮动)
- [一、浮动（float）](#一浮动float)
    - [1.1 传统网页布局的三种方式](#11-传统网页布局的三种方式)
    - [1.2 标准流（普通流/文档流）](#12-标准流普通流文档流)
    - [1.3 为什么需要浮动？](#13-为什么需要浮动)
    - [1.4 什么是浮动？](#14-什么是浮动)
    - [1.5 浮动特性（重难点）](#15-浮动特性重难点)
    - [1.6 浮动元素经常和标准流父级搭配使用](#16-浮动元素经常和标准流父级搭配使用)
- [二、常见网页布局](#二常见网页布局)
    - [2.1 初识常见网页布局](#21-初识常见网页布局)
    - [2.2 浮动布局注意点](#22-浮动布局注意点)
- [三、清除浮动](#三清除浮动)
    - [3.1 思考题](#31-思考题)
    - [3.2 为什么需要清除浮动？](#32-为什么需要清除浮动)
    - [3.3 清除浮动本质](#33-清除浮动本质)
    - [3.4 清除浮动](#34-清除浮动)
    - [3.5 清除浮动方法](#35-清除浮动方法)
    - [3.6 清除浮动 —— 额外标签法](#36-清除浮动--额外标签法)
    - [3.7 清除浮动 —— 父级添加 overflow](#37-清除浮动--父级添加-overflow)
    - [3.8 清除浮动 —— :after 伪元素法](#38-清除浮动--after-伪元素法)
    - [3.9 清除浮动 —— 双伪元素清除浮动](#39-清除浮动--双伪元素清除浮动)
    - [3.10 清除浮动总结](#310-清除浮动总结)
...
<img src="img/image27.png" style="width:60%;" />

2. **如何实现两个盒子的左右对齐？**

<img src="img/image28.png" style="width:60%;" />
...
<img src="img/image29.png" style="width:60%;" />
