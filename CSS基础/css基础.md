...
- [【CSS简介、基础选择器、字体属性、文本属性、引入方式】](#css简介基础选择器字体属性文本属性引入方式)
- [一、CSS简介](#一css简介)
    - [1.1 HTML的局限性](#11-html的局限性)
    - [1.2 CSS网页的美容师](#12-css网页的美容师)
    - [1.3 CSS语法规范](#13-css语法规范)
    - [1.4 CSS代码风格](#14-css代码风格)
        - [1.4.1 样式格式书写](#141-样式格式书写)
        - [1.4.2 样式大小书写](#142-样式大小书写)
        - [1.4.3 空格规范](#143-空格规范)
- [二、CSS基础选择器](#二css基础选择器)
    - [2.1 CSS选择器的作用](#21-css选择器的作用)
    - [2.2 选择器的分类](#22-选择器的分类)
    - [2.3 标签选择器](#23-标签选择器)
    - [2.4 类选择器](#24-类选择器)
    - [2.5 id选择器](#25-id选择器)
    - [2.6 通配符选择器](#26-通配符选择器)
    - [2.7 基础选择器总结](#27-基础选择器总结)
- [三、CSS字体属性](#三css字体属性)
    - [3.1 字体系列](#31-字体系列)
    - [3.2 字体大小](#32-字体大小)
    - [3.3 字体粗细](#33-字体粗细)
    - [3.4 文字样式](#34-文字样式)
    - [3.5 字体复合属性](#35-字体复合属性)
    - [3.6 字体属性总结](#36-字体属性总结)
- [四、CSS文本属性](#四css文本属性)
    - [4.1 文本颜色](#41-文本颜色)
    - [4.2 文本对齐](#42-文本对齐)
    - [4.3 文本装饰](#43-文本装饰)
    - [4.4 文本缩进](#44-文本缩进)
    - [4.5 行间距（行高）](#45-行间距行高)
    - [4.6 文本属性总结](#46-文本属性总结)
- [五、CSS引入方式](#五css引入方式)
    - [5.1 CSS的三种引入方式](#51-css的三种引入方式)
    - [5.2 行内样式表](#52-行内样式表)
    - [5.3 内部样式表](#53-内部样式表)
    - [5.4 外部样式表](#54-外部样式表)
    - [5.5 CSS引入方式总结](#55-css引入方式总结)
