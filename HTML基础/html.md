...
> 熟悉`语义化标签`、`表单元素`及`HTML5新特性`（如Canvas、本地存储）。
## 目录
...
- [一、HTML简介](#一html简介)
    - [1.1 网页](#11-网页)
        - [1.1.1 什么是网页？](#111-什么是网页)
        - [1.1.2 什么是HTML?](#112-什么是html)
        - [1.1.3 网页的形成](#113-网页的形成)
    - [1.2 浏览器](#12-浏览器)
        - [1.2.1 常用浏览器](#121-常用浏览器)
        - [1.2.2 浏览器内核](#122-浏览器内核)
    - [1.3 Web标准](#13-web标准)
        - [1.3.1 为什么需要Web标准？](#131-为什么需要web标准)
        - [1.3.2 Web标准的构成](#132-web标准的构成)
- [二、HTML标签](#二html标签)
    - [2.1 HTML语法规范](#21-html语法规范)
        - [2.1.1 基本语法概述](#211-基本语法概述)
        - [2.1.2 标签关系](#212-标签关系)
    - [2.2 HTML基础结构标签](#22-html基础结构标签)
        - [2.2.1 第一个HTML网页](#221-第一个html网页)
    - [2.3 网页开发工具](#23-网页开发工具)
        - [2.3.1 文档类型声明标签](#231-文档类型声明标签)
        - [2.3.2 lang语言种类](#232-lang语言种类)
        - [2.3.3 字符集](#233-字符集)
        - [2.3.4 IE 兼容模式](#234-ie-兼容模式)
    - [2.4 HTML常用标签](#24-html常用标签)
        - [2.4.1 标签语义](#241-标签语义)
        - [2.4.2 标题标签](#242-标题标签)
        - [2.4.3 段落和换行标签](#243-段落和换行标签)
        - [2.4.4 文本格式化标签](#244-文本格式化标签)
        - [2.4.5 \<div\>和\<span\>标签](#245-div和span标签)
        - [2.4.6 图像标签和路径](#246-图像标签和路径)
        - [2.4.7 超链接标签](#247-超链接标签)
    - [2.5 HTML中的注释和特殊字符](#25-html中的注释和特殊字符)
        - [2.5.1 注释](#251-注释)
        - [2.5.2 特殊字符](#252-特殊字符)
    - [2.6 表格标签](#26-表格标签)
        - [2.6.1 表格的主要作用](#261-表格的主要作用)
        - [2.6.2 表格的基本语法](#262-表格的基本语法)
        - [2.6.3 表头单元格标签](#263-表头单元格标签)
        - [2.6.4 表格属性](#264-表格属性)
        - [2.6.5 表格结构标签](#265-表格结构标签)
        - [2.6.6 合并单元格](#266-合并单元格)
    - [2.7 列表标签](#27-列表标签)
        - [2.7.1 无序列表](#271-无序列表)
        - [2.7.2 有序列表](#272-有序列表)
        - [2.7.3 自定义列表](#273-自定义列表)
    - [2.8 表单标签](#28-表单标签)
        - [2.8.1 为什么需要表单](#281-为什么需要表单)
        - [2.8.2 表单的组成](#282-表单的组成)
        - [2.8.3 表单域](#283-表单域)
        - [2.8.4 表单控件（表单元素）](#284-表单控件表单元素)
        - [2.8.5 表单元素几个总结](#285-表单元素几个总结)
    - [2.9 案例](#29-案例)
    - [2.10 内联框架](#210-内联框架)
        - [2.10.1 iframe 语法](#2101-iframe-语法)
        - [2.10.2 iframe - 设置高度与宽度](#2102-iframe---设置高度与宽度)
- [三、SEO优化](#三seo优化)
